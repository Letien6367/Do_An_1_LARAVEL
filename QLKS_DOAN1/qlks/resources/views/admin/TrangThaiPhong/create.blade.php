...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1">Thêm trạng thái phòng</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.trang-thai-phong.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Tên trạng thái <span class="text-danger">*</span></label>
                            <input type="text" name="TenTrangThai" class="form-control @error('TenTrangThai') is-invalid @enderror" value="{{ old('TenTrangThai') }}" placeholder="Nhập tên trạng thái...">
